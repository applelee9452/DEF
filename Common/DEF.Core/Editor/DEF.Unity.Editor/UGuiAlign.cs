...
public class UGuiAlign : Editor
{
    ...
    public static void Align(UGuiAlignType type, List<RectTransform> rects)
    {
        ...
        switch (type)
        {
            ...
            case UGuiAlignType.Bottom:
                ...
                break;
            case UGuiAlignType.HorizontalCenter:
                for (int i = 1; i < rects.Count; i++)
                {
                    RectTransform trans = rects[i];
                    float tw = trans.sizeDelta.x * trans.lossyScale.x;
                ...
                break;
            case UGuiAlignType.VerticalCenter:
                for (int i = 1; i < rects.Count; i++)
                {
                    RectTransform trans = rects[i];
                    float th = trans.sizeDelta.y * trans.localScale.y;
