namespace NPBehave
{
    public class Action : Task
    {
        ...
        public Action(Behave behave, System.Action action)
            : base(behave, "Action")
        {
            this.action = action;
        }

        public Action(Behave behave, System.Func<bool, Result> multiframeFunc)
            : base(behave, "Action")
        {
            this.multiFrameFunc = multiframeFunc;
        }

        public Action(Behave behave, System.Func<Request, Result> multiframeFunc2)
            : base(behave, "Action")
        {
        ...
        public Action(Behave behave, System.Func<bool> singleFrameFunc)
            : base(behave, "Action")
        {
