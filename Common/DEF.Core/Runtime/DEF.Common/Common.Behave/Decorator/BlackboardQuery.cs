namespace NPBehave
{
    public class BlackboardQuery : ObservingDecorator
    {
        ...
        public BlackboardQuery(Behave behave, string[] keys, Stops stopsOnChange, System.Func<bool> query, Node decoratee)
            : base(behave, "BlackboardQuery", stopsOnChange, decoratee)
        {
            this.keys = keys;
            this.query = query;
        }
