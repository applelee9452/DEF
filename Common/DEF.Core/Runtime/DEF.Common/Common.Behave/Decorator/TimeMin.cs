namespace NPBehave
{
    public class TimeMin : Decorator
    {
        ...
        public TimeMin(Behave behave, float limit, Node decoratee)
            : base(behave, "TimeMin", decoratee)
        {
            this.limit = limit;
        ...
        public TimeMin(Behave behave, float limit, bool waitOnFailure, Node decoratee)
            : base(behave, "TimeMin", decoratee)
        {
            this.limit = limit;
            this.randomVariation = this.limit * 0.05f;
        ...
        public TimeMin(Behave behave, float limit, float randomVariation, bool waitOnFailure, Node decoratee)
            : base(behave, "TimeMin", decoratee)
        {
            this.limit = limit;
