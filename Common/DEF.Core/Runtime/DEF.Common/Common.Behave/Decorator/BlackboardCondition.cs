namespace NPBehave
{
    public class BlackboardCondition : ObservingDecorator
    {
        ...
        public BlackboardCondition(Behave behave, string key, Operator op, object value, Stops stopsOnChange, Node decoratee)
            : base(behave, "BlackboardCondition", stopsOnChange, decoratee)
        {
            this.op = op;
            this.key = key;
            this.value = value;
        ...
        public BlackboardCondition(Behave behave, string key, Operator op, Stops stopsOnChange, Node decoratee)
            : base(behave, "BlackboardCondition", stopsOnChange, decoratee)
        {
            this.op = op;
            this.key = key;
