namespace NPBehave
{
    public class Service : Decorator
    {
        ...
        public Service(Behave behave, float interval, float randomVariation, System.Action service, Node decoratee)
            : base(behave, "Service", decoratee)
        {
        ...
        public Service(Behave behave, float interval, System.Action service, Node decoratee)
            : base(behave, "Service", decoratee)
        {
            this.serviceMethod = service;
            this.interval = interval;
        ...
        public Service(Behave behave, System.Action service, Node decoratee)
            : base(behave, "Service", decoratee)
        {
            this.serviceMethod = service;
