namespace NPBehave
{
    public class Cooldown : Decorator
    {
        ...
        public Cooldown(Behave behave, float cooldownTime, float randomVariation, bool startAfterDecoratee, bool resetOnFailiure, bool failOnCooldown, Node decoratee)
            : base(behave, "TimeCooldown", decoratee)
        {
        ...
        public Cooldown(Behave behave, float cooldownTime, bool startAfterDecoratee, bool resetOnFailiure, bool failOnCooldown, Node decoratee)
            : base(behave, "TimeCooldown", decoratee)
        {
            this.startAfterDecoratee = startAfterDecoratee;
            this.cooldownTime = cooldownTime;
        ...
        public Cooldown(Behave behave, float cooldownTime, float randomVariation, bool startAfterDecoratee, bool resetOnFailiure, Node decoratee)
            : base(behave, "TimeCooldown", decoratee)
        {
            this.startAfterDecoratee = startAfterDecoratee;
            this.cooldownTime = cooldownTime;
        ...
        public Cooldown(Behave behave, float cooldownTime, bool startAfterDecoratee, bool resetOnFailiure, Node decoratee)
            : base(behave, "TimeCooldown", decoratee)
        {
            this.startAfterDecoratee = startAfterDecoratee;
            this.cooldownTime = cooldownTime;
        ...
        public Cooldown(Behave behave, float cooldownTime, float randomVariation, Node decoratee)
            : base(behave, "TimeCooldown", decoratee)
        {
        ...
        public Cooldown(Behave behave, float cooldownTime, Node decoratee)
            : base(behave, "TimeCooldown", decoratee)
        {
            this.startAfterDecoratee = false;
            this.cooldownTime = cooldownTime;
