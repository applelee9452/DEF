...
namespace NPBehave
{
    public class Parallel : Composite
    {
        ...
        public Parallel(Behave behave, Policy successPolicy, Policy failurePolicy, /*Wait waitForPendingChildrenRule,*/ params Node[] children)
            : base(behave, "Parallel", children)
        {
