...
namespace DEF.UCenter
{
    ...
    [GenerateSerializer]
#endif
    public partial class AccountFacebookOAuthInfo
    {
        [ProtoMember(1)]
#if !DEF_CLIENT
        [Id(0)]
    ...
    [GenerateSerializer]
#endif
    public partial class AccountFacebookAutoLoginRequest
    {
        [ProtoMember(1)]
#if !DEF_CLIENT
        [Id(0)]
    ...
    [GenerateSerializer]
#endif
    public partial class FacebookAuthInfo
    {
        [ProtoMember(1)]
#if !DEF_CLIENT
        [Id(0)]
        ...
        [Id(9)]
#endif
        public string HeadImgUrl { get; set; }// 头像地址
    }
}