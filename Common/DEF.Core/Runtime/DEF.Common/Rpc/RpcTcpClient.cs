...
namespace DEF
{
    ...
    {
        public bool IsConnected { get { return (MbTcpClient == null) ? false : MbTcpClient.IsConnected; } }
        ...
        public RpcTcpClient(IClient client, string host, int port)
        {
            Client = client;
            Host = host;
            Port = port;
            ...
            if (MbTcpClient == null)
            {
                ...
                MbTcpClient = go_networktcpclient.GetComponent<NetworkClientTcp>();
                if (MbTcpClient == null)
                {
                    MbTcpClient = go_networktcpclient.AddComponent<NetworkClientTcp>();
                }
