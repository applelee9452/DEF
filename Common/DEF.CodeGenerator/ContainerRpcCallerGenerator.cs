...
{
    [Generator]
    public class ContainerRpcCallerGenerator : ISourceGenerator
    {
...
#endif
            context.RegisterForSyntaxNotifications(() => new DerivedInterfacesReceiver("DEF.IContainerRpc"));
        }
...
[RegisterContainerRpcCallerFactory]
public class {factory_name} : ContainerRpcCallerFactory
{{
    ...
    public override ContainerRpcAttribute GetContainerRpcAttribute()
    {{
        var t = typeof({interface_name});
        return DEFUtils.GetContainerRpcAttribute(t);
    }}

    public override IContainerRpc CreateContainerRpc(IRpcInfo rpcinfo, IRpcer rpcer)
    {{
