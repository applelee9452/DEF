...
{
    [Generator]
    public class ComponentRpcCallerGenerator : ISourceGenerator
    {
...
#endif
            context.RegisterForSyntaxNotifications(() => new DerivedInterfacesReceiver("DEF.IComponentRpc"));
        }
        ...
        public void Execute(GeneratorExecutionContext context)
        {
            ...
            foreach (var i in interfaces)
            {
                ...
                foreach (var m in members)
                {
                    ...
                    sb_methods.Append(" ");
                    sb_methods.Append(interface_name);
                    sb_methods.Append(".");
...
[RegisterComponentRpcCallerFactory]
public class {factory_name} : ComponentRpcCallerFactory
{{
    ...
    public override ComponentRpcAttribute GetComponentRpcAttribute()
    {{
        var t = typeof({interface_name});
        return DEFUtils.GetComponentRpcAttribute(t);
    }}

    public override IComponentRpc CreateComponentRpc(IRpcInfo rpcinfo, IRpcer rpcer)
    {{
